...
function CheckoutPage() {
  ...
  const paystackAmount = Math.round(total * 100); // Paystack expects kobo/pesewas/cents
      ...
      const handler = window.PaystackPop.setup({
        ...
        onSuccess: async (tx) => {
          try {
            ...
            // This prevents fake payments — Paystack confirms
            // the transaction on our backend before saving.
            ...
            toast.error(
              ...
              "Contact support with ref: " + tx.reference
            );
            setLoading(false);
          }
        },
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
            ...
            <div className="space-y-4">
              ...
              <Button
                ...
                disabled={loading}
                className="w-full h-12 gap-2 font-bold text-[oklch(0.14_0.06_75)] shadow-[var(--shadow-gold)] text-base"
