...
function AuthPage() {
  ...
  async function handleGoogle() {
    ...
    // Sign out any existing session first so we never carry over a previous
    // user's tokens into the new OAuth flow. This is the key fix for the
    // account-switching bug: without this, Google silently reuses the cached
    // browser session and Supabase returns the old user.
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        // Force Google to always show the account-picker screen.
        // Without this, Google reuses the last signed-in account silently.
