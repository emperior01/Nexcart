      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 10, width: "100%", marginBottom: 16 }}>
        {isLoading ? (
          ...
          <>
            ...
            <StatCard label="Revenue" value={fmt(stats!.revenue)} icon={TrendingUp} gradient="linear-gradient(135deg,#10B981,#065F46)" />
          </>
        )}
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 10, marginBottom: 24 }}>
        {isLoading ? (
          ...
          <>
            ...
            <StatCard label="Pending Payouts" value={fmt(stats!.pendingWithdrawalsTotal)} icon={Wallet} gradient="linear-gradient(135deg,#06B6D4,#0891B2)" />
          </>
        )}
      </div>
