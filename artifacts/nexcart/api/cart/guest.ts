...
export default async function handler(req: any, res: any) {
  ...
  // so IP is the only identifier available. Normal tier, fails open — a
  // Redis outage shouldn't stop people from adding things to their cart.
  if (await enforceRateLimit(req, res, "cart:guest")) return;
