#!/usr/bin/env python3
"""
Full rewrite of seller Layout.tsx — fixes Store icon + adds View My Store link.
Run from ~/nexcart_scott:
    python3 rewrite_seller_layout.py
"""
import os

BASE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "artifacts/nexcart")
path = os.path.join(BASE, "src/pages/seller/Layout.tsx")
...
print("✅ Done: artifacts/nexcart/src/pages/seller/Layout.tsx")
print("""
Now run:
  cd ~/nexcart_scott
  git add artifacts/nexcart/src/pages/seller/Layout.tsx
  git commit -m "fix: Store icon import + View My Store link in seller sidebar"
  git push
""")
