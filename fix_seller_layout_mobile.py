#!/usr/bin/env python3
"""
Fix seller Layout.tsx mobile responsiveness.
Run from inside ~/nexcart_scott:
    python3 fix_seller_layout_mobile.py
"""
import os
...
print("  git add artifacts/nexcart/src/pages/seller/Layout.tsx")
print('  git commit -m "fix: seller layout proper mobile responsiveness"')
print("  git push")
